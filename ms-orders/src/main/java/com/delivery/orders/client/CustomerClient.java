...
@FeignClient(name = "ms-customers", url = "http://ms-customers:8082")// anotacion para indicar que esta interfaz es un cliente Feign que se comunica con el microservicio de clientes
